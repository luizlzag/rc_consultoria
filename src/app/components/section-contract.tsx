        ...
        <section className='bg-white p-2'>
            <GridContainer>
                ...
                <div className='grid grid-cols-3 gap-4 max-md:grid-cols-1 cursor-default'>
                    <div className='rounded-md bg-primary-500 px-4 py-4 transition-all hover:outline outline-primary-300'>
                    ...
                    <div className='rounded-md bg-primary-500 px-4 py-4 transition-all hover:outline hover:outline-primary-300'>
