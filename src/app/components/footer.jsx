         ...
         <footer className='bottom-0 py-4 px-4 bg-primary-100 text-center h-[160%] '>
            <div className=' flex justify-between  cursor-pointer max-md:grid  '>
               ...
               <div className=' gap-4 max-md:flex'>
                        <a href='https://www.instagram.com/rctributaria/?hl=fr' target='_blank' className=' py-2 px-2 rounded-full '><FaInstagram size={36} color={'white'} className='max-md:w-5'/></a>
                        <a href='https://www.facebook.com/profile.php?id=61550853845754' target='_blank' className='py-2 px-2 rounded-full'><FaFacebook size={36} color={'white'} className='max-md:w-5'/></a>
                        <a href='https://www.linkedin.com/company/rc-consultoria-tribut%C3%A1ria/' target='_blank' className=' py-2 px-2 rounded-full'><FaLinkedin size={36} color={'white'} className='max-md:w-5'/></a>
               </div>
            </div>
            <div className='pt-2 flex justify-around items-center gap-6 max-md:grid'>
